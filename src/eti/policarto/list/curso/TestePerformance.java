...
public class TestePerformance {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Inserção Normal na ArrayList demorou  " + tempoArrayList);
        System.out.println("Inserção Normal na LinkedList demorou " + tempoLinkedList);
        ...
        System.out.println("Ordenação na ArrayList demorou  " + tempoArrayList);
        System.out.println("Ordenação na LinkedList demorou " + tempoLinkedList);
